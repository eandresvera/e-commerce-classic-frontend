...
export const ProfileCard = ({ tittle, subTittle, url, icon }) => {
    return (
        <Link to={`/profile/${url}`} className="h-28 flex flex-nowrap content-center border border-gray-300 space-x-6 px-6 cursor-pointer transition duration-500 ease-in-out transform hover:-translate-y-1 hover:shadow-md">
